...
class _NotifFilters extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _chip('Toutes', _NotifFilter.all, context),
          _chip('Non lues', _NotifFilter.unread, context),
          _chip('Commandes', _NotifFilter.orders, context),
          _chip('Système', _NotifFilter.system, context),
        ],
      ),
    );
  }

  Widget _chip(String label, _NotifFilter f, BuildContext context) {
